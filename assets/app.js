...
const I18N = {
  en: {
    ...
    "hero.agents": 'Installs into <span class="text-text font-medium">Claude</span> · <span class="text-text font-medium">Cursor</span> · <span class="text-text font-medium">Codex</span>',
  ...
  ko: {
    ...
    "hero.agents": '<span class="text-text font-medium">Claude</span> · <span class="text-text font-medium">Cursor</span> · <span class="text-text font-medium">Codex</span> 에 바로 설치',
